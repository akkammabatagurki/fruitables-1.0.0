...
<html lang="en">
    ...
    <?php if ($username): ?>
        <div class="dropdown">
            <a href="#" class="my-auto d-flex align-items-center dropdown-toggle" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                <i class="fas fa-user fa-2x"></i>
                <span class="ms-2 fw-bold text-primary"><?php echo htmlspecialchars($username); ?></span>
            </a>
   ...
   <button 
        ...
        data-name="Grapes"
        data-price="4.99"
        data-image="img/fruite-item-5.jpg"
    >
...
<button 
    ...
    data-price="4.99"
    data-image="img/fruite-item-2.jpg"
>
    <i class="fa fa-shopping-bag me-2 text-primary"></i>
    <span class="btn-text">Add to cart</span>
</button>                                                    </div>
...
<button 
    ...
    data-name="Apricots"
    data-price="4.99"
    data-image="img/fruite-item-4.jpg"
>
    <i class="fa fa-shopping-bag me-2 text-primary"></i>
    <span class="btn-text">Add to cart</span>
</button>                                                    </div>
...
<button 
    ...
    data-name="Banana"
    data-price="4.99"
    data-image="img/fruite-item-3.jpg"
>
    <i class="fa fa-shopping-bag me-2 text-primary"></i>
    <span class="btn-text">Add to cart</span>
</button>                                                    </div>
...
<button 
    ...
    data-name="Oranges"
    data-price="4.99"
    data-image="img/fruite-item-1.jpg"
>
    <i class="fa fa-shopping-bag me-2 text-primary"></i>
    <span class="btn-text">Add to cart</span>
</button>                                                    </div>
...
<button 
    ...
    data-name="Apple"
    data-price="4.99"
    data-image="img/fruite-item-6.jpg"
>
    <i class="fa fa-shopping-bag me-2 text-primary"></i>
    <span class="btn-text">Add to cart</span>
</button>                                                    </div>
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-6">
                        <div class="py-4">
                            ...
                            <a href="contact.html" class="banner-btn btn border-2 border-white rounded-pill text-dark py-3 px-5">BUY</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="card h-100 shadow-sm border-0">
                    <img src="img/best-product-1.jpg" class="card-img-top rounded-top" alt="Organic Tomato">
                    <div class="card-body text-center">
                        <h5 class="card-title mb-2">Organic Tomato</h5>
                        <div class="mb-2">
                        ...
                        <h4 class="mb-3 text-success">₹3.12</h4>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="card h-100 shadow-sm border-0">
                    <img src="img/best-product-2.jpg" class="card-img-top rounded-top" alt="Organic Tomato">
                    <div class="card-body text-center">
                        <h5 class="card-title mb-2">Organic Tomato</h5>
                        <div class="mb-2">
                            <i class="fas fa-star text-primary"></i>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="card h-100 shadow-sm border-0">
                    <img src="img/best-product-3.jpg" class="card-img-top rounded-top" alt="Organic Tomato">
                    <div class="card-body text-center">
                        <h5 class="card-title mb-2">Organic Tomato</h5>
                        <div class="mb-2">
                            <i class="fas fa-star text-primary"></i>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="card h-100 shadow-sm border-0">
                    <img src="img/best-product-4.jpg" class="card-img-top rounded-top" alt="Organic Tomato">
                    <div class="card-body text-center">
                        <h5 class="card-title mb-2">Organic Tomato</h5>
                        <div class="mb-2">
                            <i class="fas fa-star text-primary"></i>
