...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href="salesreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Sales Report</a>                </li><li><a href="contacts.php"><i class="icon-envelope icon-2x"></i> Contacts</a></li>
			<br><br><br><br><br><br>
			<li>
