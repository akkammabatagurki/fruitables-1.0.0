  ...
  <div class="row-fluid">
    ...
    <div class="span10">
        ...
        <form action="incoming.php" method="post" >
            <input type="hidden" name="pt" value="<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>" />
            <input type="hidden" name="invoice" value="<?php echo isset($_GET['invoice']) ? $_GET['invoice'] : ''; ?>" />
        ...
        <table class="table table-bordered" id="resultTable" data-responsive="table">
            ...
            <tbody>
                ...
                <tr class="record">
                    ...
                    <td width="90">
                        <a href="delete.php?id=<?php echo $row['transaction_id']; ?>&invoice=<?php echo isset($_GET['invoice']) ? $_GET['invoice'] : ''; ?>&dle=<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['product'];?>
                ...
                <tr>
                    ...
                    <?php
                    $sdsd=isset($_GET['invoice']) ? $_GET['invoice'] : '';
                    $resultas = $db->prepare("SELECT sum(amount) FROM sales_order WHERE invoice= :a");
                    $resultas->bindParam(':a', $sdsd);
                    $resultas->execute();
                    $fgfg = 0;
                    if ($rowas = $resultas->fetch()) {
        ...
        <a rel="facebox" href="checkout.php?pt=<?php echo isset($_GET['id']) ? $_GET['id'] : '' ?>&invoice=<?php echo isset($_GET['invoice']) ? $_GET['invoice'] : '' ?>&total=<?php echo isset($fgfg) ? $fgfg : 0 ?>&totalprof=<?php echo isset($asd) ? $asd : 0 ?>&cashier=<?php echo $_SESSION['SESS_FIRST_NAME']; ?>
            <button class="btn btn-success btn-large btn-block"><i class="icon icon-save icon-large"></i> SAVE</button>
        </a>
